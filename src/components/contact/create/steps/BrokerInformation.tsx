...
function BrokerInformation({ activeStep, setActiveStep }: any) {
    useEffectOnce(() => {
    ...
    return (
        <>
            ...
            <div className='mt-6 flex justify-between items-center gap-10'>
                ...
                {activeStep < 5 ? <button className='border border-black/30 px-4 py-1.5 rounded-lg' onClick={() => { setActiveStep(activeStep + 1) }}>Next</button> : <div></div>}
            </div>
